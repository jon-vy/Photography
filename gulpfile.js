...
gulp.task('js', function() {/* объеденить (конкатинировать) несколько js файлов */
    return gulp.src([
        'node_modules/slick-carousel/slick/slick.js',/* пути к этим  */
        'node_modules/wow.js/dist/wow.js',              /* файлам */
        'node_modules/masonry-layout/dist/masonry.pkgd.min.js',              /* файлам */
...
gulp.task('browser-sync', function() {
    browserSync.init({
        ...
        proxy: "Free-Photography-Website-Template",
        open: true,
        notify: false
